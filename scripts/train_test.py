...
from tandem.src.olds.transfer_learning import train_model
...
if __name__ == "__main__":
    ...
    # train_model(
    #     base_models="/mnt/nas_1/YangLab/loci/tandem/models/different_number_of_layers/20250423-1234-tandem/n_hidden-5",
