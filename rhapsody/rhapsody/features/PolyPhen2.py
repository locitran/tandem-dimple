...
def queryPolyPhen2(filename, dump=True, prefix='pph2',
    ...
    print('Submitting query to PolyPhen-2...')
    ...
    for k in exts:
        ...
        if k == 'started':
            ...
            print('Query to PolyPhen-2 started in %.1fs.', '_started')
            print('PolyPhen-2 is running...')
        elif k == 'completed':
    ...
    if Uniprot_accs:
        if fix_isoforms:
            print('PolyPhen-2 may have picked the wrong isoforms.')
            print('Resubmitting query with correct isoforms --- '
            ...
            print('Please check PolyPhen-2 log file')
        else:
...
def parsePolyPhen2output(pph2_output):
    ...
    print("PolyPhen-2's output parsed.")
    return parsed_lines
...
def calcPolyPhen2features(PolyPhen2output):
    ...
    print("Sequence-conservation features have been "
